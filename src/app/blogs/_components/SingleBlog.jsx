...
const SingleBlog = () => {
    ...
    return (
        <div className='w-[80%] md:w-[70%] mx-auto flex flex-col justify-center items-center py-5 md:py-15'>
            <div style={{ backgroundColor: style.lightBG.backgroundColor }} className='flex flex-col lg:flex-row items-center justify-between md:px-10 md:gap-10 border rounded-xl'>
                <div className='lg:w-1/2 p-5'>
                    <img src={blogData[0].image.src} className='h-[400px] object-cover mx-auto rounded-xl' alt="" />
                </div>
                <div className='lg:w-1/2 space-y-3 pb-5 px-5'>
