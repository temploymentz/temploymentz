    ...
    <>
      ...
      <div className='border-t-2' style={{ backgroundColor: style.lightBG.backgroundColor }}>
        <div className='py-10 md:py-0 w-[85%] xl:w-[80%] mx-auto flex flex-col md:flex-row justify-between min-h-[80vh] items-center'>
          ...
          <div className='md:w-[50%] flex justify-center'>
            <img src={heroSection.src} className='object-cover mt-10 h-[450px] md:mt-0 md:object-contain md:h-[600px] xl:h-[600px]' alt="" />
          </div>
        </div>
      </div>

      {/* Empowering */}
      <div className='w-[85%] md:w-[80%] mx-auto flex flex-col justify-center min-h-[95vh] items-center pt-20'>
        <div className='space-y-5 text-center'>
          <h1 className={`${style.minHeader.fontSize} leading-9 md:leading-14 ${style.minHeader.fontWeight}`}>Empowering Growth Through Flexible Work <br /> <span className='text-yellow-500'>Connections</span></h1>
          <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-10 py-10 xl:py-20'>
            {
      ...
      <div className=' py-30 mx-auto flex justify-center min-h-[80vh] items-center'>
        <div className='space-y-10 text-center w-[85%] md:w-[80%]'>
          <h1 className={`${style.minHeader.fontSize} leading-10 md:leading-15 ${style.minHeader.fontWeight}`}>Connecting India’s Leading Industries with <br /> <span className='text-blue-600'>Skilled Gig Professionals</span></h1>
        ...
        <div className='w-[85%] md:w-[80%] mx-auto flex flex-col justify-center min-h-screen items-center py-15 '>
          <div className='space-y-10 text-center'>
            <div className='flex flex-col gap-7 lg:gap-0 lg:flex-row justify-between'>
              <h1 className={`lg:w-1/5 ${style.minHeader.fontSize} leading-10 lg:leading-15 ${style.minHeader.fontWeight}`}>Why  Choose <span className='text-blue-600'>Temploymentz?</span></h1>
              <p className={`lg:w-3/5 lg:text-left ${style.para.fontSize} font-medium ${style.para.lineHeight}`}>
      ...
      <div className='w-[85%] md:w-[80%] mx-auto flex flex-col justify-center min-h-[80vh] py-15'>
        <div className='space-y-10'>
          <h1 className={`${style.minHeader.fontSize} text-center md:text-left leading-10 md:leading-14 ${style.minHeader.fontWeight}`}>Experiences Shared by <br /> <span className='text-blue-600'>Our Clients</span></h1>
        </div>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-y-10 gap-x-10 xl:grid-cols-3 justify-between w-full py-20'>
          {
