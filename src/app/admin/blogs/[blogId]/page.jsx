...
export default function EditBlogPage() {
  ...
  // Check authorization and fetch blog
  useEffect(() => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          intro: blog.intro || "",
          keyPoints: blog.keyPoints?.join(", ") || "",
          sections: typeof blog.sections === "string" ? blog.sections : JSON.stringify(blog.sections || []),
      ...
      <div className="bg-white shadow">
        <div className="max-w-4xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-blue-600">Edit Blog</h1>
