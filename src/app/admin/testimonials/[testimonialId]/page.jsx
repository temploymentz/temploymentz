...
export default function EditTestimonialPage() {
  ...
  // Check authorization and fetch testimonial
  useEffect(() => {
    ...
    fetchTestimonial();
  }, [session, status, router, testimonialId]);
      ...
      <div className="bg-white shadow">
        <div className="max-w-4xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-blue-600">Edit Testimonial</h1>
              <p className="text-gray-600 mt-1">Update testimonial details</p>
            </div>
